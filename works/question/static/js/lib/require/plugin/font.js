...
define(['propertyParser'], function (propertyParser) {
    ...
    return {
        ...
        //example: fonts!google,families:[Tangerine,Cantarell,Yanone Kaffeesatz:700]
        load : function(name, req, onLoad, config){
            if (config.isBuild) {
                ...
                req([(document.location.protocol === 'https:'? 'https' : 'http') +'://ajax.googleapis.com/ajax/lib/webfont/1/webfont.js'], function(){
                    WebFont.load(data);
                });
            }
        }
